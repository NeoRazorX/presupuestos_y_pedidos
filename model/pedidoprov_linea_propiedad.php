 ...
 * Orientado para guardar datos adicionales para las líneas del pedido.
 *
 * @author Carlos García Gómez <neorazorx@gmail.com>
 */
class pedidoprov_linea_propiedad extends \fs_model
{
    /**
     * Nombre
     * @var string
    ...
    {
        parent::__construct('pedidoprov_linea_propiedades');
        if ($a) {
            $this->name = $a['name'];
    ...
    public function save()
    {
        if ($this->exists()) {
            ...
            $sql = "INSERT INTO pedido_linea_propiedades (name, idpedido, idlinea, text) VALUES ("
    ...
    public function array_save($idpedido, $idlinea, $values)
    {
        ...
        foreach ($values as $key => $value) {
            $aux = new \pedido_linea_propiedad();
            $aux->name = $key;
