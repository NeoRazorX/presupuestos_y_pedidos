 ...
 * Orientado para guardar datos adicionales para las observaciones del pedido.
 *
 * @author Carlos García Gómez <neorazorx@gmail.com>
 */
class pedidoprov_obs_propiedad extends \fs_model
{
    /**
     * Nombre
     * @var string
    ...
    {
        parent::__construct('pedidoprov_obs_propiedades');
        if ($a) {
            $this->name = $a['name'];
    ...
    public function save()
    {
        if ($this->exists()) {
            ...
            $sql = "INSERT INTO pedido_obs_propiedades (name, idpedido, text) VALUES ("
